...
Thank you for looking into contributing to`rn-dailyjs-screen-share-extension`!  We welcome your contributions toward making [Daily](https://www.daily.co) the easiest real-time video API for developers to use in their products.
...
Before creating a new bug report, please check to see if somebody else has [already filed the issue](https://github.com/daily-co/rn-screen-share-extension/issues) before creating a new one.

If you need to create an issue, we'll ask you to tell us:
